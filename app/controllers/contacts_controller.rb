class ContactsController < ApplicationController
  ...
  before_action :set_kinds, only: [:edit, :new, :create, :update]

  # http_basic_authenticate_with name: "evandro", password: "123", only: :destroy
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:name, :email, :kind_id, :observation,
